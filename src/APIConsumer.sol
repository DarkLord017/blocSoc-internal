...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        ...
        req._add(
            "get",
            "https://finnhub.io/api/v1/quote?symbol=TSLA&token=cpqmslhr01qo647ns8j0cpqmslhr01qo647ns8jg"
        );
        ...
        req._add("path", "c"); // Chainlink nodes 1.0.0 and later support this format
